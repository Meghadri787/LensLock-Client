...
const EmptyBucket = ({ bucketId }) => {
    return (
        <motion.div
            className="flex flex-col items-center justify-center py-16 px-4 text-center rounded-xl border-2 border-dashed border-gray-200 bg-white"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
            ...
            <p className="text-gray-500 max-w-md mb-8">
                Upload photos or videos to start building your collection
            </p>
